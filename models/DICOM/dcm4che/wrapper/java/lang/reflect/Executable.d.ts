 ...
 */
export declare class ExecutableClass extends JavaClass {
    /**
     * Original type: 'int'
     */
...
declare const Executable_base: typeof ExecutableClass;
/**
 ...
 * You should probably not edit this.
 */
export declare class Executable extends Executable_base {
    /**
