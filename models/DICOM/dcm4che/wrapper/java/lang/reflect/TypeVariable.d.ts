...
/**
 * This class just defines types, you should import {@link TypeVariable} instead of this.
...
export declare class TypeVariableClass extends JavaClass {
     ...
     */
    getGenericDeclaration(): Promise<java_lang_reflect_GenericDeclaration | null>;
    /**
     * @return original return type: 'java.lang.reflect.GenericDeclaration'
     */
    getGenericDeclarationSync(): java_lang_reflect_GenericDeclaration | null;
    /**
     * @return original return type: 'java.lang.reflect.AnnotatedType[]'
     */
    getAnnotatedBounds(): Promise<(java_lang_reflect_AnnotatedType | null)[] | null>;
    /**
     * @return original return type: 'java.lang.reflect.AnnotatedType[]'
     */
 ...
 * you should use {@link createTypeVariableProxy} for actually creating the proxies.
 *
 ...
 * @return the proxy
 */
export declare function createTypeVariableProxy(methods: TypeVariableInterface, opts?: InterfaceProxyOptions): JavaInterfaceProxy<TypeVariableInterface>;
declare const TypeVariable_base: typeof TypeVariableClass;
/**
 ...
 * You should probably not edit this.
 */
export declare class TypeVariable extends TypeVariable_base {
    /**
