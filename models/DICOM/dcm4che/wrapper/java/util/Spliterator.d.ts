...
/**
 * This class just defines types, you should import {@link Spliterator} instead of this.
 * This was generated by java-bridge.
 * You should probably not edit this.
 */
export declare class SpliteratorClass extends JavaClass {
    /**
     * Original type: 'int'
     */
     ...
     */
    trySplit(): Promise<Spliterator | null>;
    /**
     * @return original return type: 'java.util.Spliterator'
     */
    trySplitSync(): Spliterator | null;
    /**
     * @param var0 original type: 'java.util.function.Consumer'
 ...
 * you should use {@link createSpliteratorProxy} for actually creating the proxies.
 *
 ...
 * You should probably not edit this.
 */
export interface SpliteratorInterface {
    /**
     * @param var0 original type: 'java.util.function.Consumer'
     * @return original return type: 'void'
     */
 ...
 * @return the proxy
 */
export declare function createSpliteratorProxy(methods: SpliteratorInterface, opts?: InterfaceProxyOptions): JavaInterfaceProxy<SpliteratorInterface>;
declare const Spliterator_base: typeof SpliteratorClass;
/**
 ...
 * You should probably not edit this.
 */
export declare class Spliterator extends Spliterator_base {
    /**
