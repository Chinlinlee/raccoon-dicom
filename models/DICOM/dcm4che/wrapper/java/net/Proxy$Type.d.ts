...
/**
 * This class just defines types, you should import {@link Proxy$Type} instead of this.
...
export declare class Proxy$TypeClass extends JavaClass {
     ...
     */
    static readonly DIRECT: Proxy$TypeClass | null;
    /**
     * Original type: 'java.net.Proxy$Type'
     */
    static readonly HTTP: Proxy$TypeClass | null;
    /**
     * Original type: 'java.net.Proxy$Type'
     */
    static readonly SOCKS: Proxy$TypeClass | null;
    /**
     * @return original return type: 'java.net.Proxy$Type[]'
     */
    static values(): Promise<(Proxy$Type | null)[] | null>;
    /**
     * @return original return type: 'java.net.Proxy$Type[]'
     */
    static valuesSync(): (Proxy$Type | null)[] | null;
    /**
     * @param var0 original type: 'java.lang.String'
     * @return original return type: 'java.net.Proxy$Type'
     */
    static valueOf(var0: string | null): Promise<Proxy$Type | null>;
    /**
     * @param var0 original type: 'java.lang.String'
     * @return original return type: 'java.net.Proxy$Type'
     */
    static valueOfSync(var0: string | null): Proxy$Type | null;
    /**
...
declare const Proxy$Type_base: typeof Proxy$TypeClass;
/**
 ...
 * You should probably not edit this.
 */
export declare class Proxy$Type extends Proxy$Type_base {
}
export default Proxy$Type;
//# sourceMappingURL=Proxy$Type.d.ts.map